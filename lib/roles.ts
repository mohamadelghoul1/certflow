...
export type FirmRole = "director" | "staff";
...
// What `is_director()` said. Before migration 0072 the function does not
// exist, and every certifier is a director because that is what they
// have always been; any other failure reads the same way rather than
// locking a director out of their own firm over a hiccup.
export function directorFromAnswer(data: unknown, error: { code?: string; message?: string } | null): boolean {
