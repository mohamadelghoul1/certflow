...
// Every deadline the firm is standing under, worst first. The rows come
// from lib/compliance — each links straight to the place it gets fixed.

export async function ComplianceList({ firmId }: { firmId: string }) {
  const supabase = await createClient();
  const items = await getComplianceItems(supabase, firmId, todayISO());
