...
// The pre-inspection report as it appears on screen, laid out the way the
// certificate is — same navy ruled headings, same right-aligned fields —
// so the pack a certifier hands over reads as one set of documents.
//
// The contents of the page only; the caller supplies the sheet around it,
// because the report is shown both on its own and as one page inside the
// approval it belongs to.
export function PreInspectionReportBody({ data }: { data: PreInspectionData }) {
