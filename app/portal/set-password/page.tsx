    ...
    <div className="min-h-screen bg-teal-950 flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <div className="mt-2 text-[12px] tracking-[0.2em] uppercase text-teal-300">Welcome — set your password</div>
        </div>
        <form action={formAction} className="bg-white rounded-lg p-6 space-y-4 shadow-xl">
          <p className="text-sm text-slate-600">Choose a password for your CertFlow client portal login.</p>
          <div>
            <label className="block text-xs font-semibold text-slate-500 mb-1">New password (min. 8 characters)</label>
            <input name="password" type="password" required minLength={8} className="w-full px-3 py-2 rounded-md border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-teal-600" />
          </div>
