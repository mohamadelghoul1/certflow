  ...
  return (
    <MarketingShell current="/why-certlyn">
      ...
      <Section title="What it deliberately does not do" lead="A tool for a regulated profession should be as clear about its limits as its features.">
        <ul className="max-w-2xl space-y-4 text-[15px] leading-relaxed text-slate-300">
          <li className="flex gap-3">
            <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[#f0b93a]" />
            <span>
              <span className="font-semibold text-white">The AI never decides anything.</span> It writes up facts the app already holds and
          ...
          <li className="flex gap-3">
            <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[#f0b93a]" />
            <span>
              <span className="font-semibold text-white">Nothing is sent on its own.</span> Certificates, reports, notes to clients &mdash;
          ...
          <li className="flex gap-3">
            <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[#f0b93a]" />
            <span>
              <span className="font-semibold text-white">A silence is never a clearance.</span> When a map service has nothing over a parcel,
      ...
      <CallToAction title="See it running on your own projects." blurb="Register your interest and we'll set your firm up, walk you through it, and bring your current jobs across from a spreadsheet." />
    </MarketingShell>
  );
}
