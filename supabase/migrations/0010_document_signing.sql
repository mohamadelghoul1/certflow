...
alter table pathway_certificate_versions add column signed_at timestamptz;
alter table jobs add column pathway_signed_at timestamptz;

alter table oc_records add column signed_at timestamptz;

alter table inspections add column report_signed_at timestamptz;
