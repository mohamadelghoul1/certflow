...
export const config = {
  ...
  matcher: ["/((?!_next/static|_next/image|favicon.ico|manifest.webmanifest|icons/|api/portal-files/|api/eplanning/|api/cron/|api/stripe/|api/calendar/|api/client-error|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"],
};
